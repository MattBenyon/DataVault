...
def QueryUnit(experimentalunitID, sessionID):
    treatmentID = experimentalunitID + 160
    conn = connect(
        dbname='v4_test',
        user='g09',
        host="localhost",
    ...
    select = ''' 
        ...
        WHERE EndpointUnitLINK.ExperimentalUnitID = 11 AND TreatmentHUB.TreatmentID = 161 AND MeasuresLINK.SessionID = 1 AND DataSourceLINK.DataSourceID = 1
