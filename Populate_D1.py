...
def InsertData(filepath, db_name, db_user, db_password, experimentalunitnumber, endpointnumber,
    ...
    for i in range(row_count):
        ...
        insert = "INSERT INTO SessionHUB (Source, timestamp, Acquisitiontimestamp) VALUES (%s, current_timestamp, %s);"  # update description

        cursor.execute(insert, (hashed_user, acquisition_time))
        conn.commit()
    ...
    for i in range(row_count):
        ...
        #print(experimentalunitnumber, endpointnumber)
    ...
    insert = "INSERT INTO MeasuresLINK (Source, timestamp, ExperimentalUnitID, SessionID) VALUES ('" + hashed_user + "', current_timestamp, %s, 1);"
